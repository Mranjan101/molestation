...
smd({
  ...
  try {
    ...
    if (!_0x1c586e) {
      return await _0x1ae8f8.reply("*Provide Repo Url, _.gitclone https://github.com/MASTER-HACKER-INDIA/MASTER-MIND-V3*");
    }
...
smd({
  ...
  try {
    ...
    if (!_0x204f81) {
      return _0x55aba2.reply("*_Example : .tts Hi,I am MASTER-MIND-V3 whatsapp bot._*");
    }
    try {
