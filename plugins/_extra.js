...
smd({
  ...
  try {
    ...
    if (!_0x587b99) {
      return await _0x4cdec8.reply("*Need URL! Use " + prefix + "ss https://github.com/MASTER-HACKER-INDIA/MASTER-MIND-V3*");
    }
...
let tmpUrl = "https://i.imgur.com/g2i6Xwz.jpeg";
const secmailData = {};
smd({
  pattern: "tempmail",
